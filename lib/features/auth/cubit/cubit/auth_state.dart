...
final class ResetPassworSuccessState extends AuthState {}

final class ResetPassworFailureState extends AuthState {
  final String errorMsg;
  ResetPassworFailureState({required this.errorMsg});
}
